...
This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository. `AGENTS.md` is a stub that points back here — this is the canonical, maintained copy.
